"""
Django settings for cold_forest_41208 project.
...
ROOT_URLCONF = 'cold_forest_41208.urls'
...
WSGI_APPLICATION = 'cold_forest_41208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_forest_41208 API",
    "DESCRIPTION": "API documentation for cold_forest_41208 App",
    "VERSION": "v1",
}
